...
$templates = [
    'survey' => [
        ...
        'columns' => ['วันที่รับ', 'ประเภทรังวัด', 'ผู้ขอ', 'สรุปเรื่อง', 'สาเหตุค้าง', 'คนคุมเรื่อง', 'เลข รว.12'],
        'sample' => ['2026-01-16', 'แบ่งแยก', 'นางสาวทดสอบ', 'รอตรวจสอบ', 'รอคู่กรณี', 'นายทดสอบ', '123/2569']
    ],
    'registration' => [
